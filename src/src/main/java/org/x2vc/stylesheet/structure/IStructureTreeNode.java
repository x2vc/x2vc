...
public interface IStructureTreeNode extends Serializable {
	...
	/**
	 * @return <code>true</code> if the element is an XSLT directive that can be
	 *         cast to {@link IXSLTDirectiveNode}
	 */
	boolean isXSLTDirective();

	/**
	 * @return the element reference as an {@link IXSLTDirectiveNode} if it is of
	 *         the correct type
	...
	/**
	 * @return <code>true</code> if the element is an XSLT parameter that can be
	 *         cast to {@link IXSLTParameterNode}
	 */
	boolean isXSLTParameter();

	/**
	 * @return the element reference as an {@link IXSLTParameterNode} if it is of
	 *         the correct type
	 * @throws IllegalStateException if the type of the tree node does not match
	 */
	...
	/**
	 * @return <code>true</code> if the element is an XSLT sorting instruction that
	 *         can be cast to {@link IXSLTSortNode}
	 */
	boolean isXSLTSort();

	/**
	 * @return the element reference as an {@link IXSLTSortNode} if it is of the
	 *         correct type
	 * @throws IllegalStateException if the type of the tree node does not match
	 */
	 ...
	 *         cast to {@link IXMLNode}
	 */
	boolean isXML();

	/**
	 * @return the element reference as an {@link IXMLNode} if it is of the correct
	 *         type
	 * @throws IllegalStateException if the type of the tree node does not match
	 */
	...
	/**
	 * @return <code>true</code> if the element is a simple text node and can be
	 *         cast to {@link ITextNode}
	 */
	boolean isText();

	/**
	 * @return the element reference as an {@link ITextNode} if it is of the correct
	 *         type
	 * @throws IllegalStateException if the type of the tree node does not match
	 */
