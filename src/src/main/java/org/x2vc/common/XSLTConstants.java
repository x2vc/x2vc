...
public class XSLTConstants {
	 ...
	 */
	public static final String ELEMENT_APPLY_IMPORTS = "apply-imports";

	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:apply-templates select =
	 * node-set-expression mode = qname&gt; &lt;!-- Content: (xsl:sort |
	 * xsl:with-param)* --&gt; &lt;/xsl:apply-templates&gt; </pre>
	 *
	 * @see <a
	 * href="https://www.w3.org/TR/xslt-10/#element-apply-templates">apply-templates
	 * </a>
	 */
	public static final String ELEMENT_APPLY_TEMPLATES = "apply-templates";

	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:attribute name = { qname }
	...
	/*
	 * <pre> &lt;!-- Category: top-level-element --&gt; &lt;xsl:attribute-set name =
	 * qname use-attribute-sets = qnames&gt; &lt;!-- Content: xsl:attribute* --&gt;
	 * &lt;/xsl:attribute-set&gt; </pre>
	 *
	 * @see <a
	 * href="https://www.w3.org/TR/xslt-10/#element-attribute-set">attribute-set</a>
	 */
	public static final String ELEMENT_ATTRIBUTE_SET = "attribute-set";

	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:call-template name =
	 * qname&gt; &lt;!-- Content: xsl:with-param* --&gt; &lt;/xsl:call-template&gt;
	 * </pre>
	 *
	 * @see <a
	 * href="https://www.w3.org/TR/xslt-10/#element-call-template">call-template</a>
	 */
	public static final String ELEMENT_CALL_TEMPLATE = "call-template";

	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:choose&gt; &lt;!--
	 * Content: (xsl:when+, xsl:otherwise?) --&gt; &lt;/xsl:choose&gt; </pre>
	 *
	 * @see <a href="https://www.w3.org/TR/xslt-10/#element-choose">choose</a>
	 */
	public static final String ELEMENT_CHOOSE = "choose";

	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:comment&gt; &lt;!--
	 * Content: template --&gt; &lt;/xsl:comment&gt; </pre>
	 *
	...
	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:copy use-attribute-sets =
	 * qnames&gt; &lt;!-- Content: template --&gt; &lt;/xsl:copy&gt; </pre>
	 *
	...
	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:copy-of select =
	 * expression /&gt; </pre>
	 *
	 * @see <a href="https://www.w3.org/TR/xslt-10/#element-copy-of">copy-of</a>
	 */
	public static final String ELEMENT_COPY_OF = "copy-of";

	/*
	 * <pre> &lt;!-- Category: top-level-element --&gt; &lt;xsl:decimal-format name
	 ...
	 * char digit = char pattern-separator = char /&gt; </pre>
	 *
	 * @see <a
	 * href="https://www.w3.org/TR/xslt-10/#element-decimal-format">decimal-format</
	 * a>
	 */
	public static final String ELEMENT_DECIMAL_FORMAT = "decimal-format";

	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:element name = { qname }
	 * namespace = { uri-reference } use-attribute-sets = qnames&gt; &lt;!--
	 * Content: template --&gt; &lt;/xsl:element&gt; </pre>
	 *
	...
	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:fallback&gt; &lt;!--
	 * Content: template --&gt; &lt;/xsl:fallback&gt; </pre>
	 *
	 * @see <a href="https://www.w3.org/TR/xslt-10/#element-fallback">fallback</a>
	 */
	public static final String ELEMENT_FALLBACK = "fallback";

	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:for-each select =
	 * node-set-expression&gt; &lt;!-- Content: (xsl:sort*, template) --&gt;
	 * &lt;/xsl:for-each&gt; </pre>
	 *
	 * @see <a href="https://www.w3.org/TR/xslt-10/#element-for-each">for-each</a>
	 */
	public static final String ELEMENT_FOR_EACH = "for-each";

	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:if test =
	...
	/*
	 * <pre> &lt;xsl:import href = uri-reference /&gt; </pre>
	 *
	...
	/*
	 * <pre> &lt;!-- Category: top-level-element --&gt; &lt;xsl:include href =
	 * uri-reference /&gt; </pre>
	 *
	...
	/*
	 * <pre> &lt;!-- Category: top-level-element --&gt; &lt;xsl:key name = qname
	 * match = pattern use = expression /&gt; </pre>
	 *
	...
	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:message terminate = "yes"
	 * | "no"&gt; &lt;!-- Content: template --&gt; &lt;/xsl:message&gt; </pre>
	 *
	...
	/*
	 * <pre> &lt;!-- Category: top-level-element --&gt; &lt;xsl:namespace-alias
	 * stylesheet-prefix = prefix | "#default" result-prefix = prefix | "#default"
	 * /&gt; </pre>
	 *
	 * @see <a
	 * href="https://www.w3.org/TR/xslt-10/#element-namespace-alias">namespace-alias
	 * </a>
	 */
	public static final String ELEMENT_NAMESPACE_ALIAS = "namespace-alias";

	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:number level = "single" |
	...
	/*
	 * <pre> &lt;xsl:otherwise&gt; &lt;!-- Content: template --&gt;
	 * &lt;/xsl:otherwise&gt; </pre>
	 *
	 * @see <a href="https://www.w3.org/TR/xslt-10/#element-otherwise">otherwise</a>
	 */
	public static final String ELEMENT_OTHERWISE = "otherwise";

	/*
	 * <pre> &lt;!-- Category: top-level-element --&gt; &lt;xsl:output method =
	 ...
	 * qnames indent = "yes" | "no" media-type = string /&gt; </pre>
	 *
	...
	/*
	 * <pre> &lt;!-- Category: top-level-element --&gt; &lt;xsl:param name = qname
	...
	/*
	 * <pre> &lt;!-- Category: top-level-element --&gt; &lt;xsl:preserve-space
	 * elements = tokens /&gt; </pre>
	 *
	 * @see <a
	 * href="https://www.w3.org/TR/xslt-10/#element-preserve-space">preserve-space</
	 * a>
	 */
	public static final String ELEMENT_PRESERVE_SPACE = "preserve-space";

	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:processing-instruction
	 ...
	 */
	public static final String ELEMENT_PROCESSING_INSTRUCTION = "processing-instruction";

	/*
	 * <pre> &lt;xsl:sort select = string-expression lang = { nmtoken } data-type =
	 * { "text" | "number" | qname-but-not-ncname } order = { "ascending" |
	 * "descending" } case-order = { "upper-first" | "lower-first" } /&gt; </pre>
	 *
	 * @see <a href="https://www.w3.org/TR/xslt-10/#element-sort">sort</a>
	 */
	public static final String ELEMENT_SORT = "sort";

	/*
	 * <pre> &lt;!-- Category: top-level-element --&gt; &lt;xsl:strip-space elements
	 * = tokens /&gt; </pre>
	 *
	 * @see <a
	 * href="https://www.w3.org/TR/xslt-10/#element-strip-space">strip-space</a>
	 */
	public static final String ELEMENT_STRIP_SPACE = "strip-space";

	/*
	 * <pre> &lt;xsl:stylesheet id = id extension-element-prefixes = tokens
	 * exclude-result-prefixes = tokens version = number&gt; &lt;!-- Content:
	 * (xsl:import*, top-level-elements) --&gt; &lt;/xsl:stylesheet&gt; </pre>
	 *
	 * @see <a
	 * href="https://www.w3.org/TR/xslt-10/#element-stylesheet">stylesheet</a>
	 */
	public static final String ELEMENT_STYLESHEET = "stylesheet";

	/*
	 * <pre> &lt;!-- Category: top-level-element --&gt; &lt;xsl:template match =
	 * pattern name = qname priority = number mode = qname&gt; &lt;!-- Content:
	 * (xsl:param*, template) --&gt; &lt;/xsl:template&gt; </pre>
	 *
	...
	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:text
	...
	/*
	 * <pre> &lt;xsl:transform id = id extension-element-prefixes = tokens
	 * exclude-result-prefixes = tokens version = number&gt; &lt;!-- Content:
	 * (xsl:import*, top-level-elements) --&gt; &lt;/xsl:transform&gt; </pre>
	 *
	...
	/*
	 * <pre> &lt;!-- Category: instruction --&gt; &lt;xsl:value-of select =
	 * string-expression disable-output-escaping = "yes" | "no" /&gt; </pre>
	 *
	...
	/*
	 * <pre> &lt;!-- Category: top-level-element --&gt; &lt;!-- Category:
	 * instruction --&gt; &lt;xsl:variable name = qname select = expression&gt;
	 * &lt;!-- Content: template --&gt; &lt;/xsl:variable&gt; </pre>
	 *
	...
	/*
	 * <pre> &lt;xsl:when test = boolean-expression&gt; &lt;!-- Content: template
	 * --&gt; &lt;/xsl:when&gt; </pre>
	 *
	...
	/*
	 * <pre> &lt;xsl:with-param name = qname select = expression&gt; &lt;!--
	 * Content: template --&gt; &lt;/xsl:with-param&gt; </pre>
	 *
	 * @see <a
	 * href="https://www.w3.org/TR/xslt-10/#element-with-param">with-param</a>
	 */
	public static final String ELEMENT_WITH_PARAM = "with-param";
