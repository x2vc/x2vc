...
/**
 * Generates new {@link IDocumentRequest} objects by randomly exploring a schema
 * or adjusting a previous request according to modifier specifications.
 */
public interface IRequestGenerator {
	 ...
	 */
	IDocumentRequest generateNewRequest(IXMLSchema schema);
