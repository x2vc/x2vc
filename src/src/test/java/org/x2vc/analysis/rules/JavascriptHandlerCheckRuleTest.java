...
class JavascriptHandlerCheckRuleTest extends AnalyzerRuleTestBase {
	...
	void setUp() throws Exception {
		super.setUp();
		this.rule = new JavascriptHandlerCheckRule(this.schemaManager, Lists.newArrayList("ontosomething"));
	}
	...
	@Test
	void testRuleID() {
		assertEquals(JavascriptHandlerCheckRule.RULE_ID, this.rule.getRuleID());
	}
	...
	@CsvSource({
			...
			"<p ontosomething=\"asdfghjk\">test</p>,    -,           false",
			"<p ontosomething=\"qwer1234\">test</p>,    qwer1234,    true",
			"<p ontosomething=\"aaaqwer1234\">test</p>, aaaqwer1234, true",
			"<p ontosomething=\"qwer1234zzz\">test</p>, qwer1234zzz, true",
	})
	...
	/**
	 * Test method for
	 * {@link org.x2vc.analysis.rules.JavascriptHandlerCheckRule#verifyNode(org.jsoup.nodes.Node, org.x2vc.xml.document.IXMLDocumentContainer, java.util.function.Consumer)}.
	 *
	...
	@ParameterizedTest
	@CsvSource({
			"<p ontosomething=\"qwer1234\">test</p>,    /p, qwer1234, 1, /html/body/div/p",
			"<p ontosomething=\"aaaqwer1234\">test</p>, /p, qwer1234, 1, /html/body/div/p",
			"<p ontosomething=\"qwer1234zzz\">test</p>, /p, qwer1234, 1, /html/body/div/p",
	})
