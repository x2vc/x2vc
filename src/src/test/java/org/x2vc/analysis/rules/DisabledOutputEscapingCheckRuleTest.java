...
class DisabledOutputEscapingCheckRuleTest extends AnalyzerRuleTestBase {
	 ...
	 *
	 * @param text   the source text of the node that will be passed to the rule to
	 *               check
	...
	@CsvSource({
			...
			"qwertzui, qwer, qwertzui, 8, DATA, false",
			"qwertzui, qwer, qwertzui, 8, MIXED, true",
			"abcqwertzui, qwer, qwertzui, 8, DATA, false",
			"abcqwertzui, qwer, qwertzui, 8, MIXED, true",
			"qwertzuixyz, qwer, qwertzui, 8, DATA, false",
			"qwertzuixyz, qwer, qwertzui, 8, MIXED, true"
	})
