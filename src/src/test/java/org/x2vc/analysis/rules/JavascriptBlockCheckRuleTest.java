...
class JavascriptBlockCheckRuleTest extends AnalyzerRuleTestBase {
	...
	void setUp() throws Exception {
		super.setUp();
		this.rule = new JavascriptBlockCheckRule(this.schemaManager);
	}
	...
	@Test
	void testRuleID() {
		assertEquals(JavascriptBlockCheckRule.RULE_ID, this.rule.getRuleID());
	}
	...
	@ParameterizedTest
	@CsvSource({
			"<script>var foo='a';</script>,           -,                      false",
			"<script>var foo='qwer1234';</script>,    var foo='qwer1234';,    true",
			"<script>var foo='aaaqwer1234';</script>, var foo='aaaqwer1234';, true",
			"<script>var foo='qwer1234zzz';</script>, var foo='qwer1234zzz';, true"
	})
	...
	/**
	 * Test method for
	 * {@link org.x2vc.analysis.rules.JavascriptBlockCheckRule#verifyNode(org.jsoup.nodes.Node, org.x2vc.xml.document.IXMLDocumentContainer, java.util.function.Consumer)}.
	 *
	...
	@ParameterizedTest
	@CsvSource({
			"<script>var foo='qwer1234';</script>, /script, qwer1234, 1, /html/body/div/script",
			"<script>var foo='asdfasdf';</script>, /script, qwer1234, 0, -",
	})
	void testVerifyNode(String html, String elementSelector, String injectedElement,
		...
		if (expectedVulnerabilityCount > 0) {
			...
			assertEquals(JavascriptBlockCheckRule.RULE_ID, vc.getAnalyzerRuleID());
