...
/**
 * This component determines a unique prefix to use when generating the random values for an XML document as well as the
 * default length of the values.
 */
@ImplementedBy(PrefixSelector.class)
public interface IPrefixSelector {

	/**
	 * @param prefix      a unique prefix to use when generating the random values for an XML document
