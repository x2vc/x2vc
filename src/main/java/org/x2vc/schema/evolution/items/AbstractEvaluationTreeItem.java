 ...
 */
public abstract class AbstractEvaluationTreeItem<T> implements IEvaluationTreeItem {
	 ...
	 * @param target
	 */
	protected AbstractEvaluationTreeItem(IXMLSchema schema, IModifierCreationCoordinator coordinator, T target) {
		this.schema = schema;
